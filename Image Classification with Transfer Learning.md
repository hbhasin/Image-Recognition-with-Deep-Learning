...
The Keras Library version used is 1.2.2. The Tensorflow libary version is 0.12. A plan is in the work to support the latest versions of Keras and Tensorflow.
