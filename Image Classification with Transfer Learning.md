...
Tensorflow from Google is another very popular Python library used for computation in neural networks. The Keras library has the capability to run on top of Tensorflow or Theano. It would be interesting to the compare the performance of the pre-trained ImageNet Inception V3 model using Tensorflow against Keras.
